import { Bell, Brain, LayoutDashboard, MapPin, Menu, Moon, Search, Settings, Sun, Upload, X } from 'lucide-react';
           ...
           <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
             <div className="max-w-7xl mx-auto px-6 py-4">
               <div className="flex items-center justify-between">
                 ...
                 {/* Desktop Right Actions (Settings, Notifications, Profile, Dark Mode) */}
                 <div className="hidden lg:flex items-center gap-4">
                   ...
                   >
                     <Sun className="w-5 h-5 dark:hidden text-gray-600" />
                     <Moon className="w-5 h-5 hidden dark:block text-gray-600" />
                   </button>
                   <button className="p-2 rounded-lg hover:bg-blue-50" title="Settings">
                   ...
                   <button className="p-2 rounded-lg hover:bg-blue-50" title="Profile">
                     <img
               ...
               {isMenuOpen && (
                 <div className="lg:hidden mt-4 flex flex-col gap-2 pb-4">
                   ...
                   <div className="flex flex-col gap-2 px-4 py-3">
                     ...
                     <button
                       className="flex items-center gap-2 px-4 py-3 rounded-lg hover:bg-blue-50 relative"
                       onClick={() => setIsMenuOpen(false)}
                     >
